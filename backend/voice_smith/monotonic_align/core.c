...
{
    "distutils": {
        "name": "voice_smith.monotonic_align.core",
        "sources": [
            "core.pyx"
        ]
    },
    "module_name": "voice_smith.monotonic_align.core"
}
END: Cython Metadata */
...
#define __PYX_HAVE__voice_smith__monotonic_align__core
#define __PYX_HAVE_API__voice_smith__monotonic_align__core
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
struct __pyx_opt_args_11voice_smith_15monotonic_align_4core_maximum_path_each;

/* "voice_smith/monotonic_align/core.pyx":7
...
/* Module declarations from 'voice_smith.monotonic_align.core' */
...
static void __pyx_f_11voice_smith_15monotonic_align_4core_maximum_path_each(__Pyx_memviewslice, __Pyx_memviewslice, int, int, struct __pyx_opt_args_11voice_smith_15monotonic_align_4core_maximum_path_each *__pyx_optional_args); /*proto*/
static void __pyx_f_11voice_smith_15monotonic_align_4core_maximum_path_c(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "voice_smith.monotonic_align.core"
extern int __pyx_module_is_main_voice_smith__monotonic_align__core;
int __pyx_module_is_main_voice_smith__monotonic_align__core = 0;

/* Implementation of 'voice_smith.monotonic_align.core' */
...
static PyObject *__pyx_pf_11voice_smith_15monotonic_align_4core_maximum_path_c(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_paths, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_t_ys, __Pyx_memviewslice __pyx_v_t_xs); /* proto */
...
static void __pyx_f_11voice_smith_15monotonic_align_4core_maximum_path_each(__Pyx_memviewslice __pyx_v_path, __Pyx_memviewslice __pyx_v_value, int __pyx_v_t_y, int __pyx_v_t_x, struct __pyx_opt_args_11voice_smith_15monotonic_align_4core_maximum_path_each *__pyx_optional_args) {
  ...
  /* "voice_smith/monotonic_align/core.pyx":13
 *   cdef float v_cur
 *   cdef float tmp
 ...
 */
  ...
  /* "voice_smith/monotonic_align/core.pyx":15
 *   cdef int index = t_x - 1
 * 
 *   for y in range(t_y):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "voice_smith/monotonic_align/core.pyx":16
 * 
 *   for y in range(t_y):
 *     for x in range(max(0, t_x + y - t_y), min(t_x, y + 1)):             # <<<<<<<<<<<<<<
 *       if x == y:
 ...
 */
    ...
    for (__pyx_t_5 = __pyx_t_7; __pyx_t_5 < __pyx_t_6; __pyx_t_5+=1) {
      ...
      /* "voice_smith/monotonic_align/core.pyx":17
 *   for y in range(t_y):
 *     for x in range(max(0, t_x + y - t_y), min(t_x, y + 1)):
 *       if x == y:             # <<<<<<<<<<<<<<
 *         v_cur = max_neg_val
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "voice_smith/monotonic_align/core.pyx":18
 *     for x in range(max(0, t_x + y - t_y), min(t_x, y + 1)):
 *       if x == y:
 *         v_cur = max_neg_val             # <<<<<<<<<<<<<<
 *       else:
 ...
 */
      ...
      /* "voice_smith/monotonic_align/core.pyx":20
 *         v_cur = max_neg_val
 *       else:
 *         v_cur = value[y-1, x]             # <<<<<<<<<<<<<<
 *       if x == 0:
 ...
 */
      ...
      /* "voice_smith/monotonic_align/core.pyx":21
 *       else:
 *         v_cur = value[y-1, x]
 *       if x == 0:             # <<<<<<<<<<<<<<
 *         if y == 0:
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "voice_smith/monotonic_align/core.pyx":22
 *         v_cur = value[y-1, x]
 *       if x == 0:
 *         if y == 0:             # <<<<<<<<<<<<<<
 *           v_prev = 0.
 ...
 */
        ...
        if (__pyx_t_8) {
          ...
          /* "voice_smith/monotonic_align/core.pyx":23
 *       if x == 0:
 *         if y == 0:
 *           v_prev = 0.             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
        ...
        /* "voice_smith/monotonic_align/core.pyx":25
 *           v_prev = 0.
 *         else:
 *           v_prev = max_neg_val             # <<<<<<<<<<<<<<
 *       else:
 ...
 */
      ...
      /* "voice_smith/monotonic_align/core.pyx":27
 *           v_prev = max_neg_val
 *       else:
 *         v_prev = value[y-1, x-1]             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "voice_smith/monotonic_align/core.pyx":28
 *       else:
 *         v_prev = value[y-1, x-1]
 *       value[y, x] += max(v_prev, v_cur)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "voice_smith/monotonic_align/core.pyx":30
 *       value[y, x] += max(v_prev, v_cur)
 * 
 *   for y in range(t_y - 1, -1, -1):             # <<<<<<<<<<<<<<
 *     path[y, index] = 1
 ...
 */
  for (__pyx_t_1 = (__pyx_v_t_y - 1); __pyx_t_1 > -1; __pyx_t_1-=1) {
    ...
    /* "voice_smith/monotonic_align/core.pyx":31
 * 
 *   for y in range(t_y - 1, -1, -1):
 *     path[y, index] = 1             # <<<<<<<<<<<<<<
 *     if index != 0 and (index == y or value[y-1, index] < value[y-1, index-1]):
 ...
 */
    ...
    *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_path.data + __pyx_t_10 * __pyx_v_path.strides[0]) )) + __pyx_t_9)) )) = 1;
    ...
    /* "voice_smith/monotonic_align/core.pyx":32
 *   for y in range(t_y - 1, -1, -1):
 *     path[y, index] = 1
 *     if index != 0 and (index == y or value[y-1, index] < value[y-1, index-1]):             # <<<<<<<<<<<<<<
 *       index = index - 1
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "voice_smith/monotonic_align/core.pyx":33
 *     path[y, index] = 1
 *     if index != 0 and (index == y or value[y-1, index] < value[y-1, index-1]):
 *       index = index - 1             # <<<<<<<<<<<<<<
 * 
...
/* "voice_smith/monotonic_align/core.pyx":38
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static PyObject *__pyx_pw_11voice_smith_15monotonic_align_4core_1maximum_path_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_11voice_smith_15monotonic_align_4core_maximum_path_c(__Pyx_memviewslice __pyx_v_paths, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_t_ys, __Pyx_memviewslice __pyx_v_t_xs, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "voice_smith/monotonic_align/core.pyx":39
 * @cython.wraparound(False)
 * cpdef void maximum_path_c(int[:,:,::1] paths, float[:,:,::1] values, int[::1] t_ys, int[::1] t_xs) nogil:
 *   cdef int b = paths.shape[0]             # <<<<<<<<<<<<<<
 *   cdef int i
 ...
 */
  ...
  /* "voice_smith/monotonic_align/core.pyx":41
 *   cdef int b = paths.shape[0]
 *   cdef int i
 *   for i in prange(b, nogil=True):             # <<<<<<<<<<<<<<
                    ...
                    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                        {
                            ...
                            /* "voice_smith/monotonic_align/core.pyx":42
 *   cdef int i
 *   for i in prange(b, nogil=True):
 *     maximum_path_each(paths[i], values[i], t_ys[i], t_xs[i])             # <<<<<<<<<<<<<<
 */
...
__pyx_t_6 = __pyx_v_i;
                            __pyx_t_7 = __pyx_v_i;
                            __pyx_f_11voice_smith_15monotonic_align_4core_maximum_path_each(__pyx_t_4, __pyx_t_5, (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_t_ys.data) + __pyx_t_6)) ))), (*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_t_xs.data) + __pyx_t_7)) ))), NULL);
...
/* Python wrapper */
static PyObject *__pyx_pw_11voice_smith_15monotonic_align_4core_1maximum_path_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11voice_smith_15monotonic_align_4core_1maximum_path_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("voice_smith.monotonic_align.core.maximum_path_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11voice_smith_15monotonic_align_4core_maximum_path_c(__pyx_self, __pyx_v_paths, __pyx_v_values, __pyx_v_t_ys, __pyx_v_t_xs);
...
static PyObject *__pyx_pf_11voice_smith_15monotonic_align_4core_maximum_path_c(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_paths, __Pyx_memviewslice __pyx_v_values, __Pyx_memviewslice __pyx_v_t_ys, __Pyx_memviewslice __pyx_v_t_xs) {
  ...
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_11voice_smith_15monotonic_align_4core_maximum_path_c(__pyx_v_paths, __pyx_v_values, __pyx_v_t_ys, __pyx_v_t_xs, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 38, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "voice_smith.monotonic_align.core.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "voice_smith.monotonic_align.core.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "voice_smith.monotonic_align.core.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "voice_smith.monotonic_align.core._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"maximum_path_c", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11voice_smith_15monotonic_align_4core_1maximum_path_c, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_voice_smith__monotonic_align__core) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "voice_smith.monotonic_align.core")) {
      if (unlikely(PyDict_SetItemString(modules, "voice_smith.monotonic_align.core", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  /* "voice_smith/monotonic_align/core.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init voice_smith.monotonic_align.core", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init voice_smith.monotonic_align.core");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
